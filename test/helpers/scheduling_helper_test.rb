...
class SchedulingHelperTest < ActionView::TestCase
  ...
  def expected_schedule
    {"track_1"=>{"morning"=>[{"nome"=>"Diminuindo tempo de execução de testes em aplicações Rails enterprise", "duracao"=>60, "inicio"=>"09:00", "fim"=>"10:00"}, {"nome"=>"Trabalho remoto: prós e cons", "duracao"=>60, "inicio"=>"10:00", "fim"=>"11:00"}, {"nome"=>"Reinventando a roda em ASP clássico", "duracao"=>45, "inicio"=>"11:00", "fim"=>"11:45"}, {"nome"=>"Rails para usuários de Django", "duracao"=>5, "inicio"=>"11:45", "fim"=>"11:50"}], "afternoon"=>[{"nome"=>"Erros de Ruby oriundos de versões erradas de gems", "duracao"=>45, "inicio"=>"13:00", "fim"=>"13:45"}, {"nome"=>"Erros comuns em Ruby", "duracao"=>45, "inicio"=>"13:45", "fim"=>"14:30"}, {"nome"=>"Desenvolvimento orientado a gambiarras", "duracao"=>45, "inicio"=>"14:30", "fim"=>"15:15"}, {"nome"=>"Apresentando Lua para as massas", "duracao"=>30, "inicio"=>"15:15", "fim"=>"15:45"}, {"nome"=>"Aplicações isomórficas: o futuro (que talvez nunca chegaremos)", "duracao"=>30, "inicio"=>"15:45", "fim"=>"16:15"}]}}
  end

  def expected_sanitized_response
    {"track_1"=>[{"nome"=>"Diminuindo tempo de execução de testes em aplicações Rails enterprise", "duracao"=>60, "inicio"=>"09:00", "fim"=>"10:00"}, {"nome"=>"Trabalho remoto: prós e cons", "duracao"=>60, "inicio"=>"10:00", "fim"=>"11:00"}, {"nome"=>"Reinventando a roda em ASP clássico", "duracao"=>45, "inicio"=>"11:00", "fim"=>"11:45"}, {"nome"=>"Rails para usuários de Django", "duracao"=>5, "inicio"=>"11:45", "fim"=>"11:50"}, {:nome=>"Almoço", :duracao=>60, :inicio=>"12:00", :fim=>"13:00"}, {"nome"=>"Erros de Ruby oriundos de versões erradas de gems", "duracao"=>45, "inicio"=>"13:00", "fim"=>"13:45"}, {"nome"=>"Erros comuns em Ruby", "duracao"=>45, "inicio"=>"13:45", "fim"=>"14:30"}, {"nome"=>"Desenvolvimento orientado a gambiarras", "duracao"=>45, "inicio"=>"14:30", "fim"=>"15:15"}, {"nome"=>"Apresentando Lua para as massas", "duracao"=>30, "inicio"=>"15:15", "fim"=>"15:45"}, {"nome"=>"Aplicações isomórficas: o futuro (que talvez nunca chegaremos)", "duracao"=>30, "inicio"=>"15:45", "fim"=>"16:15"}, {:nome=>"Evento de Networking", :inicio=>"17:00"}]}
  end
